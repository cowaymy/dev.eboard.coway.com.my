	...
	>
		<template #activator="{ on, attrs }">
			<v-btn
				...
				:class="[
					{ 'bg-gradient-primary group-activator-active': isActive },
		...
		<v-list ref="refContent" :elevation="$vuetify.theme.dark ? 9 : 8">
...
@include app-elevation(
	'horizontal-nav-header-group .v-menu__content > .v-list',
	8
);
</style>
