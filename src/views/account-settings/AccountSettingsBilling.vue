  ...
  <v-card flat class="pa-3">
      ...
      <v-form class="multi-col-validation">
        <v-row>
          ...
          <v-col cols="12" md="4" sm="6">
            <v-card outlined>
              <v-card-text>
                <v-checkbox v-model="currentPlan" class="mt-0">
                  <template #label>
                ...
                <v-btn
                  ...
                  class="mt-2"
                  @click="
                    isPlanUpgradeDialogVisible = !isPlanUpgradeDialogVisible
                  "
                >
                  Upgrade Plan
                </v-btn>
    ...
    <v-dialog v-model="isPlanUpgradeDialogVisible" max-width="650">
      <v-card class="py-8">
        ...
        <v-card-text
          class="d-flex align-center flex-wrap flex-sm-nowrap mt-5 px-15"
        >
          <v-select
        ...
        <v-card-text class="px-15 pt-8">
          ...
          <div class="d-flex justify-space-between flex-wrap">
            ...
            <v-btn color="error" outlined class="mt-3">
              Cancel Subscription
            </v-btn>
          </div>
        </v-card-text>
