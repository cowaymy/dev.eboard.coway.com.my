              ...
              >
                ...
                <div class="d-flex align-center flex-grow-1 flex-wrap">
                  <div class="me-2">
                    <div class="font-weight-semibold">
                      <span class="text--primary text-xS me-1"
                          >{{ fun_numFormat(data.NETSALES) }} <span class="text-xs me-1 lastmonth-font">  ({{ fun_zore(data.PM_CNT) }}) </span> <span class="text-xs me-1 lastyear-font">  ({{ (fun_zore(data.PY_CNT))}}) </span> 
                  ...
                  <div>
                    ...
                    <span class="text-xs">{{ fun_toFixed(data.TARGET) }} %</span>
                    <v-progress-linear
                      height="6"
                      rounded
...
export default {
    ...
    computed: {
      dataList() {
        return  this.$store
                  .state
                  .appPerformanceNetSales.dataItemLevel3List
                  .filter(
                      (item) =>
                      item.NAME
                          .toLowerCase()
    ...
    methods: {
      ...
      gotoLevel4(item){
            ...
            store.dispatch(`${performanceNetSales}/fetchLevel4Events`,param);
