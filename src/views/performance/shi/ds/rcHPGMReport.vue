...
import rcHPLevel3Report from "./rcHPLevel3Report";
...
export default {
  components: {
    apexchart ,rcHPLevel3Report,rcHPLevel4Report
  },
  data() {
  ...
  computed: {
      ...
      categories(){
        ...
        console.log(this.$store.state.appPerformanceRcHP.dataNameItemLevel1List)
  ...
  methods:{
      ...
      chart2HandleChartClick(event, chartContext, config){
           ...
           const dataPointIndex = config.dataPointIndex;
            ...
            const param ={};
            param.grpCode = this.$store.state.appPerformanceRcHP.dataNameItemLevel1List[dataPointIndex];
            store.dispatch(`${performanceRcHP}/fetchLevel3Events`,param);
