    ...
    <v-row>
        <v-col cols="12" md="12">
            <v-alert border="left" color="black" dark elevation="1">
              <div class="nocard">SHI Hp e-Performance</div>
            </v-alert>
        </v-col>
        ...
        <v-col cols="12" md="4">
            <rcHPLevel2Report></rcHPLevel2Report>
        </v-col>
        
        <v-col cols="12" md="4">
          <rcHPLevel3Report></rcHPLevel3Report>
        </v-col>
...
import rcHPLevel2Report from "./rcHPLevel2Report";
...
export default {
    components: {
      apexchart ,rcHPLevel2Report ,rcHPLevel3Report,rcHPLevel4Report
    },
    data() {
    ...
    methods:{
        ...
        chart2HandleChartClick(event, chartContext, config){
             ...
             const dataPointIndex = config.dataPointIndex;
              ...
              store.dispatch(`${performanceRcHP}/fetchLevel2Events` ,ov);
