...
import activeHPLevel2Report from "./activeHPLevel2Report";
...
export default {
    components: {
      apexchart ,activeHPLevel2Report ,activeHPLevel3Report
    },
    data() {
    ...
    methods:{
        ...
        chart2HandleChartClick(event, chartContext, config){
             ...
             const dataPointIndex = config.dataPointIndex;
              ...
              store.dispatch(`${performanceActiveHP}/fetchLevel2Events` ,ov);
