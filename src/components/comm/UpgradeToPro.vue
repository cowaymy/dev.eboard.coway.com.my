<template>
	...
	>
		...
		<v-card class="elevation-0" max-width="400">
			<v-img max-width="400" eager alt="materio-pro-banner"></v-img>
			<v-card-title class="font-weight-semibold">
				Materio - Vuetify Admin Template
			</v-card-title>
			<v-card-text>
				Materio Admin is the most developer friendly &amp; highly customisable
				Admin Dashboard Template based on Vuetify.
			</v-card-text>
			<v-card-text>
